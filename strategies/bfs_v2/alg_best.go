...
func (s *Strategy) BestMergeMachines(machines []*cloud.Machine) (has bool, delta float64) {
	...
	bestPos, bestCost := s.Best(machines, instances)
	if bestCost >= cost {
		return false, 0
	}
...
func (s *Strategy) Best(machines []*cloud.Machine, instances []*cloud.Instance) (bestPos []int, bestCost float64) {
